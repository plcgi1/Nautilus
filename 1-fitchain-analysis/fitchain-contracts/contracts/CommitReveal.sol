...
contract CommitReveal {
    ...
    function setup(bytes32 _commitmentId, uint256 _commitTimeout, uint256 _revealTimeout, address[] memory _voters) public onlyCommitmentNotExist(_commitmentId) returns(bool){
    ...
    function reveal(bytes32 _commitmentId, string memory _value, bool _vote) public onlyCommitmentVoters(_commitmentId) returns(bool){
    ...
    function getCommitmentResult(bytes32 _commitmentId, address[] memory verifiers) public onlyCommitmentOwner(_commitmentId) onlyAfterReveal(_commitmentId) returns(address[] memory, int8){
        uint256 votingUp = 0;
    ...
    function getCommitRevealResult(bytes32 _commitmentId) public view returns(address[] memory, int8) {
