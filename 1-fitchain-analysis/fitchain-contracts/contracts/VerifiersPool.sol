...
contract VerifiersPool {
    ...
    function getCommitRevealResults(bytes32 challengeId) public returns(address[] memory, int8 ){
    ...
    function getAvailableVerifiers() public view returns(address[] memory){
